...
NETWORK_ARGS := --rpc-url https://eth-sepolia.g.alchemy.com/v2/demo --private-key $(DEFAULT_ANVIL_KEY) --broadcast

ifeq ($(findstring --network sepolia,$(ARGS)),--network sepolia)
	NETWORK_ARGS := --rpc-url $(SEPOLIA_RPC_URL) --private-key $(PRIVATE_KEY) --broadcast --verify --eth""erscan-api-key $(ETHERSCAN_API_KEY) -vvvv
endif
